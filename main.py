...
if __name__ == "__main__": 
    ...
    print("Infix:\n", ''.join(y.conversionspecialtoks(y.infix)))  # Se imprime la notación infix 
    ...
    #print ("AQUIE"+postfix)
    print("Posfix:\n", ''.join(y.conversionspecialtoks(postfix)))  # Se imprime la notación postfix 
    generarGrafico = contruirArbol(y.conversionspecialtoks(postfix))  # Se construye un árbol a partir de la notación postfix 
